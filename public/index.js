...
(function(exports) {
  ...
  var nodeToDom = function (node) {
      return function __do() {
          var v = Web_HTML.window();
          var v1 = Web_HTML_Window.document(v)();
          var doc = Web_HTML_HTMLDocument.toDocument(v1);
          var v2 = Web_DOM_Document.createElement("div")(doc)();
          var nepn = Web_DOM_Document.toNonElementParentNode(doc);
          var v3 = Web_DOM_NonElementParentNode.getElementById("main")(nepn)();
          var root = Data_Maybe.fromJust()(v3);
          var v4 = Effect_Console.log("adding element")();
          var rootNode = Web_HTML_HTMLElement.toNode(Data_Maybe.fromJust()(Web_HTML_HTMLElement.fromElement(root)));
          var v5 = Web_DOM_Node.appendChild(Web_HTML_HTMLElement.toNode(Data_Maybe.fromJust()(Web_HTML_HTMLElement.fromElement(v2))))(rootNode)();
...
(function(exports) {
  ...
  var htmlToNode = function (v) {
      ...
      if (v instanceof Span) {
          return new HTML.Node({
              attributes: [  ],
              type: "span",
              children: [ htmlToNode(new Text(v.value0)) ]
          });
      };
      if (v instanceof Div) {
          return new HTML.Node({
      ...
      throw new Error("Failed pattern match at Main (line 19, column 1 - line 19, column 27): " + [ v.constructor.name ]);
  };
  ...
  var runApp = function (app) {
      return function (model) {
          return (function ($8) {
              return HTML.nodeToDom(htmlToNode($8));
          })(appToHtml(app));
      };
  };
  var main = (function () {
