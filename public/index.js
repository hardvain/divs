...
(function(exports) {
  ...
  var createElement = function (api) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at DOM.VirtualDOM (line 63, column 1 - line 63, column 71): " + [ api.constructor.name, v.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var main = function __do() {
      ...
      if (v instanceof Data_Maybe.Just) {
          var v1 = DOM_VirtualDOM.createElement(DOM_HTML_DOM.api)(render)();
          var v2 = DOM_HTML_DOM.api.appendChild(v1)(v.value0)();
          return Data_Unit.unit;
      };
      if (v instanceof Data_Maybe.Nothing) {
          return Data_Unit.unit;
      };
      throw new Error("Failed pattern match at Main (line 26, column 5 - line 31, column 25): " + [ v.constructor.name ]);
  };
  exports["App"] = App;
  exports["Succ"] = Succ;
  exports["Pred"] = Pred;
