              ...
              return function (ref) {
                  var eventHandler = function (eventData) {
                      return function __do() {
                          ...
                          var v2 = Effect_Ref.write(v1 + 1 | 0)(ref)();
                          var v3 = Effect_Ref.read(ref)();
                          var v4 = Effect_Console.log(Data_Show.show(Data_Show.showInt)(v3))();
                          return v.value1(eventData);
                      };
                  };
                  return api.addEventListener(v.value0)(eventHandler)(target);
              };
          };
      };
  };
  var createElement = function (api) {
      return function (v) {
          if (v instanceof Element) {
              return function __do() {
                  var v1 = Effect_Ref["new"](0)();
                  var v2 = api.createElement(v.value0.name)();
                  var v3 = Data_Foldable.traverse_(Control_Applicative.applicativeFn)(Data_Map_Internal.foldableMap)(function (v3) {
                      return function (k) {
                          return function (v4) {
                              return api.setAttribute(k)(v4)(v2);
                          };
                      };
                  })(v.value0.props);
                  var v4 = Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(function (listener) {
                      return addListener(api)(v2)(listener)(v1);
                  })(v.value0.listeners)();
                  var v5 = Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(function (child) {
                      return appendChild$prime(api)(v2)(child);
                  })(v.value0.children)();
                  return v2;
              };
          };
          ...
          throw new Error("Failed pattern match at DOM.VirtualDOM (line 86, column 1 - line 86, column 66): " + [ api.constructor.name, v.constructor.name ]);
      };
  };
  var appendChild$prime = function (api) {
      return function (parent) {
          return function (child) {
              return function __do() {
                  var v = createElement(api)(child)();
                  var v1 = api.appendChild(v)(parent)();
                  return v;
              };
          };
      };
  };
  var runApp$prime = function (nodeToMount) {
      return function (api) {
          return function (app) {
              return function (model) {
                  return function __do() {
                      var v = Effect_Ref["new"](app.init)();
                      var renderedHtml = app.render(model);
                      var v1 = createElement(api)(renderedHtml)();
                      var v2 = api.getElementById("main")();
                      if (v2 instanceof Data_Maybe.Just) {
                          return api.appendChild(v1)(v2.value0)();
                      };
                      if (v2 instanceof Data_Maybe.Nothing) {
                          return Data_Unit.unit;
                      };
                      throw new Error("Failed pattern match at DOM.VirtualDOM (line 81, column 5 - line 83, column 27): " + [ v2.constructor.name ]);
                  };
              };
          };
      };
  };
  var runApp = function (nodeToMount) {
      return function (api) {
          return function (app) {
              return runApp$prime(nodeToMount)(api)(app)(app.init);
          };
      };
  };
...
(function(exports) {
  ...
  var appUpdate = function (model) {
      return function (message) {
          ...
          throw new Error("Failed pattern match at Main (line 20, column 3 - line 24, column 1): " + [ message.constructor.name ]);
      };
  };
  var appRender = function (model) {
      return DOM_VirtualDOM.h("div")(DOM_VirtualDOM.prop([  ]))([ DOM_VirtualDOM.h(Data_Show.show(Data_Show.showInt)(model))(DOM_VirtualDOM.prop([ new Data_Tuple.Tuple("style", "color: red") ]))([ DOM_VirtualDOM.text("Number ") ]), DOM_VirtualDOM["with"](DOM_VirtualDOM.h("button")(DOM_VirtualDOM.prop([  ]))([ DOM_VirtualDOM.text("pred") ]))([ new DOM_VirtualDOM.On("click", function (v) {
          return Succ.value;
  ...
  var main = DOM_VirtualDOM.runApp("main")(DOM_HTML_DOM.api)(app);
  exports["Succ"] = Succ;
  exports["Pred"] = Pred;
