...
(function(exports) {
  ...
  var createElement = function (api) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at DOM.VirtualDOM (line 82, column 1 - line 82, column 64): " + [ api.constructor.name, v.constructor.name ]);
      };
  };
  ...
  var mount = function (nodeToMount) {
      return function (api) {
          return function (app) {
              return function __do() {
                  var v = api.getElementById("main")();
                  if (v instanceof Data_Maybe.Just) {
                      var v1 = createElement(api)(app.render(app.init))();
                      var v2 = api.appendChild(v1)(v.value0)();
                      return Data_Unit.unit;
                  };
                  if (v instanceof Data_Maybe.Nothing) {
                      return Data_Unit.unit;
                  };
                  throw new Error("Failed pattern match at DOM.VirtualDOM (line 75, column 5 - line 80, column 27): " + [ v.constructor.name ]);
              };
          };
      };
  };
...
(function(exports) {
  ...
  var main = DOM_VirtualDOM.mount("main")(DOM_HTML_DOM.api)(app);
  exports["Succ"] = Succ;
  exports["Pred"] = Pred;
