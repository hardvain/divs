...
(function(exports) {
  ...
  var update = function (model) {
      return function (message) {
          ...
          throw new Error("Failed pattern match at Main (line 36, column 3 - line 38, column 64): " + [ message.constructor.name ]);
      };
  };
  var render = function (v) {
      return DOM_Elements.div([  ])([ DOM_Elements.div([ DOM_Attributes.style("color:red") ])([ DOM_VirtualDOM.text("children") ]), Button.render(v.buttonModel), Text.render(v.textModel), DOM_Elements.h1_([ DOM_VirtualDOM.text("Header") ]), DOM_Elements.button([ DOM_Attributes.style("color: red"), DOM_Attributes.onClick(function (v1) {
          return Pred.value;
