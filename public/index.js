  ...
  var runApp = function (dictShow) {
      return function (app) {
          return function (model) {
              return function (nodeToMount) {
                  return runAppOnMessage(dictShow)(nodeToMount)(app)(model)(Data_Maybe.Nothing.value);
              };
          };
      };
  };
      ...
      return function (nodeToMount) {
          return function (app) {
              return function __do() {
                  ...
                  var v1 = Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(runApp(dictShow)(app)(app.init))(v)();
                  return Data_Unit.unit;
              };
          };
      };
