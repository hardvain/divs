...
(function(exports) {
  ...
  var setAttributes = function (v) {
      return function (element) {
          if (v instanceof Element) {
              return function __do() {
                  var v1 = Data_Foldable.traverse_(Control_Applicative.applicativeFn)(Data_Map_Internal.foldableMap)(function (v1) {
                      return function (k) {
                          return function (v2) {
                              return DOM_HTML_DOM.api.setAttribute(k)(v2)(element);
                          };
                      };
                  })(v.value0.props);
                  return element;
  ...
  var createElement = function (v) {
      return function (callback) {
          ...
          throw new Error("Failed pattern match at DOM.VirtualDOM (line 100, column 1 - line 100, column 75): " + [ v.constructor.name, callback.constructor.name ]);
      };
  };
                              ...
                              return function (v3) {
                                  ...
                                  if (v1 instanceof Data_Maybe.Just && v2 instanceof Data_Maybe.Just) {
                                      return function __do() {
                                          ...
                                          if (v4 instanceof Data_Maybe.Just) {
                                              var $100 = changed(v1.value0)(v2.value0);
                                              if ($100) {
