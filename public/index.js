...
(function(exports) {
  ...
  var appUpdate = function (model) {
      return function (message) {
          ...
          throw new Error("Failed pattern match at Main (line 27, column 3 - line 31, column 1): " + [ message.constructor.name ]);
      };
  };
  var appRender = function (model) {
      return DOM_VirtualDOM.h("div")(DOM_VirtualDOM.prop([  ]))([ DOM_VirtualDOM.h("h1")(DOM_VirtualDOM.prop([ new Data_Tuple.Tuple("style", "color: red") ]))([ DOM_VirtualDOM.text(Data_Show.show(Data_Show.showInt)(model)) ]), DOM_VirtualDOM["with"](DOM_VirtualDOM.h("button")(DOM_VirtualDOM.prop([  ]))([ DOM_VirtualDOM.text("pred") ]))([ DOM_Events.onClick(function (v) {
          ...
          return Succ.value;
      }) ]), DOM_Elements.code, DOM_VirtualDOM.h("ul")(DOM_VirtualDOM.prop([  ]))([ DOM_VirtualDOM.h("li")(DOM_VirtualDOM.prop([  ]))([ DOM_VirtualDOM.text("1") ]), DOM_VirtualDOM.h("li")(DOM_VirtualDOM.prop([  ]))([ DOM_VirtualDOM.text("2") ]), DOM_VirtualDOM.h("li")(DOM_VirtualDOM.prop([  ]))([ DOM_VirtualDOM.text("3") ]) ]) ]);
  };
  var app = {
      render: appRender,
      update: appUpdate,
