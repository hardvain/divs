...
(function(exports) {
  ...
  var render = DOM_VirtualDOM.h("div")(DOM_VirtualDOM.prop([  ]))([ DOM_VirtualDOM.h("h1")(DOM_VirtualDOM.prop([ new Data_Tuple.Tuple("style", "color: rgb(" + (Data_Show.show(Data_Show.showInt)(256) + ",0,0)")) ]))([ DOM_VirtualDOM.text("Number ") ]), DOM_VirtualDOM["with"](DOM_VirtualDOM.h("button")(DOM_VirtualDOM.prop([  ]))([ DOM_VirtualDOM.text("pred") ]))([ new DOM_VirtualDOM.On("click", function (v) {
