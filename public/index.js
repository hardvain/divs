...
(function(exports) {
  ...
  var document = function __do() {
      var $22 = Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.document)();
      return Web_HTML_HTMLDocument.toDocument($22);
  };
  var setRootElement = function (element) {
      return function (rootId) {
          return function __do() {
              ...
              var v4 = Web_DOM_Node.appendChild(Web_HTML_HTMLElement.toNode(Data_Maybe.fromJust()(Web_HTML_HTMLElement.fromElement(element))))(rootNode)();
  ...
  var createSpanElement = function (str) {
      return function (doc) {
          return Web_DOM_Document.createElement("span")(doc);
      };
  };
  var nodeToDom = function (rootId) {
      return function (v) {
          return function __do() {
              var v1 = document();
              var v2 = createSpanElement("test")(v1)();
              return setRootElement(v2)(rootId)();
          };
      };
  };
  exports["VNode"] = VNode;
