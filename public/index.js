...
(function(exports) {
  ...
  var createElement = function (api) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at DOM.VirtualDOM (line 78, column 1 - line 78, column 62): " + [ api.constructor.name, v.constructor.name ]);
      };
  };
  ...
  var mount = function (nodeToMount) {
      return function (api) {
          return function (vnode) {
              return function __do() {
                  var v = Effect_Ref["new"](new Data_Maybe.Just(vnode))();
                  var v1 = api.getElementById("main")();
                  if (v1 instanceof Data_Maybe.Just) {
                      var v2 = createElement(api)(vnode)();
                      var v3 = api.appendChild(v2)(v1.value0)();
                      return Data_Unit.unit;
                  };
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Data_Unit.unit;
                  };
                  throw new Error("Failed pattern match at DOM.VirtualDOM (line 71, column 5 - line 76, column 29): " + [ v1.constructor.name ]);
              };
          };
      };
  };
...
(function(exports) {
  ...
  var render = DOM_VirtualDOM.h("div")(DOM_VirtualDOM.prop([  ]))([ DOM_VirtualDOM.h("h1")(DOM_VirtualDOM.prop([ new Data_Tuple.Tuple("style", "color: red") ]))([ DOM_VirtualDOM.text("Number ") ]), DOM_VirtualDOM["with"](DOM_VirtualDOM.h("button")(DOM_VirtualDOM.prop([  ]))([ DOM_VirtualDOM.text("pred") ]))([ new DOM_VirtualDOM.On("click", function (v) {
      return Succ.value;
  ...
  var main = DOM_VirtualDOM.mount("main")(DOM_HTML_DOM.api)(render);
  exports["App"] = App;
  exports["Succ"] = Succ;
  exports["Pred"] = Pred;
