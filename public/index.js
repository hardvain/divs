...
(function(exports) {
  ...
  var render = function (v) {
      return DOM_Elements.button([  ])([ DOM_VirtualDOM.text(v.value0.text) ]);
  };
  var component = {
      render: render,
      update: update,
      init: new Model({
          type: new Data_Maybe.Just("primary"),
          text: "Button"
      })
  };
  exports["Model"] = Model;
...
(function(exports) {
  ...
  var update = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Text (line 17, column 1 - line 17, column 36): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var render = function (v) {
      return DOM_Elements.span([  ])([ DOM_VirtualDOM.text(Data_Show.show(Data_Show.showInt)(v.value0.value)) ]);
  };
  var component = {
      render: render,
      update: update,
      ...
      return function (message) {
          if (message instanceof Succ) {
              return {
                  ...
                  textModel: Text.component.update(model.textModel)(Text.Succ.value)
              };
          };
          if (message instanceof Pred) {
              return {
                  buttonModel: model.buttonModel,
                  textModel: Text.component.update(model.textModel)(Text.Pred.value)
              };
          };
          throw new Error("Failed pattern match at Main (line 36, column 3 - line 38, column 74): " + [ message.constructor.name ]);
      };
  };
  var render = function (v) {
      return DOM_Elements.div([  ])([ DOM_Elements.div([ DOM_Attributes.style("color:red") ])([ DOM_VirtualDOM.text("children") ]), Button.component.render(v.buttonModel), Text.component.render(v.textModel), DOM_Elements.h1_([ DOM_VirtualDOM.text("Header") ]), DOM_Elements.button([ DOM_Attributes.style("color: red"), DOM_Attributes.onClick(function (v1) {
          return Pred.value;
      }) ])([ DOM_VirtualDOM.text("pred") ]), DOM_Elements.button([ DOM_Attributes.style("color: green"), DOM_Attributes.onClick(function (v1) {
          return Succ.value;
      }) ])([ DOM_VirtualDOM.text("succ") ]), DOM_Elements.code_([ DOM_VirtualDOM.text("value") ]), DOM_Elements.ul_([ DOM_Elements.li_([ DOM_VirtualDOM.text("1") ]), DOM_Elements.li_([ DOM_VirtualDOM.text("2") ]), DOM_Elements.li_([ DOM_VirtualDOM.text("3") ]) ]) ]);
  };
  var init = {
      buttonModel: Button.component.init,
      textModel: Text.component.init
  };
  var rootComponent = {
      render: render,
      update: update,
