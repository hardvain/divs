...
(function(exports) {
  ...
  var createElement = function (api) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at DOM.VirtualDOM (line 87, column 1 - line 87, column 66): " + [ api.constructor.name, v.constructor.name ]);
      };
  };
  ...
  var runApp$prime = function (api) {
      return function (app) {
          return function (model) {
              return function (nodeToMount) {
                  return function __do() {
                      var v = Effect_Ref["new"](app.init)();
                      var htmlToRender = app.render(model);
                      var v1 = createElement(api)(htmlToRender)();
                      return api.appendChild(v1)(nodeToMount)();
                  };
              };
          };
      };
      ...
      return function (api) {
          return function (app) {
              return function __do() {
                  ...
                  var v1 = Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(runApp$prime(api)(app)(app.init))(v)();
