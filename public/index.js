  ...
  var addListener = function (target) {
      return function (v) {
          var eventHandler = function (eventData) {
              return Control_Applicative.pure(Effect.applicativeEffect)(v.value1(eventData));
          };
              ...
              return function (maybeMsg) {
                  return function __do() {
                      ...
                      var modelToRender = (function () {
                          var v1 = Data_Functor.map(Data_Maybe.functorMaybe)(app.update(oldModel))(maybeMsg);
                          if (v1 instanceof Data_Maybe.Just) {
                              return v1.value0;
                          };
                          if (v1 instanceof Data_Maybe.Nothing) {
                          ...
                          throw new Error("Failed pattern match at DOM.VirtualDOM (line 69, column 23 - line 71, column 44): " + [ v1.constructor.name ]);
                      })();
                      var htmlToRender = app.render(modelToRender);
                      var v1 = createElement(htmlToRender)();
                      return DOM_HTML_DOM.api.appendChild(v1)(nodeToMount)();
                  };
              };
          };
      };
