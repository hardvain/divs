...
(function(exports) {
  ...
  var functorEventListener = new Data_Functor.Functor(function (f) {
      return function (v) {
          return new On(v.value0, function ($13) {
      ...
      return function (v) {
          if (v instanceof Element) {
              return new Element({
                  ...
                  children: Data_Functor.map(Data_Functor.functorArray)(function (c) {
                      return Data_Functor.map(functorHtml)(f)(c);
                  })(v.value0.children),
                  listeners: Data_Functor.map(Data_Functor.functorArray)(function (el) {
                      return Data_Functor.map(functorEventListener)(f)(el);
                  })(v.value0.listeners)
              });
          };
          return v;
  ...
  exports["Text"] = Text;
  exports["functorEventListener"] = functorEventListener;
...
(function(exports) {
  ...
  var $$with = function (v) {
      return function (v1) {
          if (v instanceof App.Element) {
              return App.Element.create({
                  name: v.value0.name,
                  props: v.value0.props,
                  listeners: v1,
      ...
      return function (old) {
          return function ($$new) {
              var update = function (key) {
                  ...
                  throw new Error("Failed pattern match at DOM.VirtualDOM (line 119, column 7 - line 123, column 38): " + [ v1.constructor.name, v.constructor.name ]);
              };
  ...
  var changed = function (v) {
      return function (v1) {
          if (v instanceof App.Element && v1 instanceof App.Element) {
              return v.value0.name !== v1.value0.name;
          };
          if (v instanceof App.Text && v1 instanceof App.Text) {
          ...
          return function (target) {
              if (v instanceof App.Element) {
                  var attach = function (v1) {
                      return DOM_HTML_DOM.api.addEventListener(v1.value0)(function ($123) {
                          return callback(v1.value1($123));
                      })(target);
                  };
                  return function __do() {
              ...
              throw new Error("Failed pattern match at DOM.VirtualDOM (line 97, column 1 - line 97, column 81): " + [ v.constructor.name, callback.constructor.name, target.constructor.name ]);
          };
      };
  };
  var createElement = function (v) {
      return function (callback) {
          ...
          throw new Error("Failed pattern match at DOM.VirtualDOM (line 74, column 1 - line 74, column 75): " + [ v.constructor.name, callback.constructor.name ]);
      };
  };
  var appendChild = function (v) {
      return function (callback) {
          return function (target) {
              ...
              throw new Error("Failed pattern match at DOM.VirtualDOM (line 88, column 1 - line 88, column 81): " + [ v.constructor.name, callback.constructor.name, target.constructor.name ]);
          };
      };
  };
          ...
          return function (new$prime) {
              return function (callback) {
                  var walkChildren = function (v) {
                      return function (v1) {
                          return function (v2) {
                              if (v1 instanceof App.Element && v2 instanceof App.Element) {
                                  var walkIndexes = function ($124) {
                              ...
                              return function (v3) {
                                  ...
                                  if (v1 instanceof Data_Maybe.Just && v2 instanceof Data_Maybe.Nothing) {
                                      return function __do() {
                                          ...
                                          throw new Error("Failed pattern match at DOM.VirtualDOM (line 141, column 7 - line 143, column 29): " + [ v4.constructor.name ]);
                                      };
                                  };
                                  ...
                                  if (v1 instanceof Data_Maybe.Just && v2 instanceof Data_Maybe.Just) {
                                      return function __do() {
                                          ...
                                          if (v4 instanceof Data_Maybe.Just) {
                                              var $95 = changed(v1.value0)(v2.value0);
                                              if ($95) {
                                                  var v5 = createElement(v2.value0)(callback)();
                                                  return DOM_HTML_DOM.api.replaceChild(v5)(v4.value0)(v)();
                                              };
                                              var v5 = (function () {
                                                  if (v1.value0 instanceof App.Element && v2.value0 instanceof App.Element) {
                                          ...
                                          throw new Error("Failed pattern match at DOM.VirtualDOM (line 152, column 7 - line 163, column 36): " + [ v4.constructor.name ]);
                                      };
                                  };
                                  throw new Error("Failed pattern match at DOM.VirtualDOM (line 133, column 5 - line 133, column 89): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name, v3.constructor.name ]);
                              };
                          };
                      };
                  };
              ...
              return function (eventCallback) {
                  return function (newMsg) {
                      return function __do() {
                          ...
                          var newModel = app.rootComponent.update(v1)(newMsg);
                          var v2 = Effect_Ref.write(newModel)(v.model)();
                          var v3 = Effect_Ref.read(v.html)();
                          var newHtml = app.rootComponent.render(newModel);
  ...
  var runApp = function (app) {
      return function (nodeToMount) {
          return function __do() {
              var v = Effect_Ref["new"](app.initialState)();
              var htmlToRender = app.rootComponent.render(app.initialState);
...
(function(exports) {
  ...
  var ul = function (attributes) {
      return function (listeners) {
          return function (children) {
              return DOM_VirtualDOM["with"](DOM_VirtualDOM.h("ul")(Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)(attributes))(children))(listeners);
          };
      };
  };                                                                 
  var li = function (attributes) {
      return function (listeners) {
          return function (children) {
              return DOM_VirtualDOM["with"](DOM_VirtualDOM.h("li")(Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)(attributes))(children))(listeners);
          };
      };
  };                                                             
  var h1 = function (attributes) {
      return function (listeners) {
          return function (children) {
              return DOM_VirtualDOM["with"](DOM_VirtualDOM.h("h1")(Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)(attributes))(children))(listeners);
          };
      };
  };                                                             
  var div = function (attributes) {
      return function (listeners) {
          return function (children) {
              return DOM_VirtualDOM["with"](DOM_VirtualDOM.h("div")(Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)(attributes))(children))(listeners);
          };
      };
  };                                                               
  var code = function (attributes) {
      return function (listeners) {
          return function (children) {
              return DOM_VirtualDOM["with"](DOM_VirtualDOM.h("code")(Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)(attributes))(children))(listeners);
          };
      };
  };                                                                     
  var button = function (attributes) {
      return function (listeners) {
          return function (children) {
              return DOM_VirtualDOM["with"](DOM_VirtualDOM.h("button")(Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)(attributes))(children))(listeners);
          };
      };
  };
...
(function(exports) {
  ...
  var render = function (v) {
      if (v.value0 instanceof Data_Maybe.Just) {
          return DOM_Elements.button([ new Data_Tuple.Tuple("class", v.value0.value0) ])([  ])([ DOM_VirtualDOM.text(v.value0.value0) ]);
      };
      return DOM_Elements.button([  ])([  ])([ DOM_VirtualDOM.text("Click Me") ]);
  };
  var component = {
      render: render,
      update: update,
      init: new Type(Data_Maybe.Nothing.value)
  };
  exports["Type"] = Type;
...
(function(exports) {
  ...
  var DOM_VirtualDOM = PS["DOM.VirtualDOM"];
  var Web_Event_Internal_Types = PS["Web.Event.Internal.Types"];
  var onClick = App.On.create("click");
...
(function(exports) {
  ...
  var fromButtonMessage = function (v) {
      return Succ.value;
  };
  var appUpdate = function (model) {
      return function (message) {
          if (message instanceof Succ) {
              return {
                  buttonModel: new Button.Type(new Data_Maybe.Just("succ"))
              };
          };
  ...
  var appRender = function (v) {
      return DOM_Elements.div([  ])([  ])([ DOM_Elements.div([ new Data_Tuple.Tuple("style", "color:red") ])([  ])([ DOM_VirtualDOM.text("children") ]), Data_Functor.map(App.functorHtml)(function (v1) {
          return Succ.value;
      })(Button.component.render(v.buttonModel)), DOM_Elements.h1([ new Data_Tuple.Tuple("style", "color: red") ])([  ])([ DOM_VirtualDOM.text("Header") ]), DOM_Elements.button([ new Data_Tuple.Tuple("style", "color: red") ])([ DOM_Events.onClick(function (v1) {
          return Pred.value;
      }) ])([ DOM_VirtualDOM.text("pred") ]), DOM_Elements.button([ new Data_Tuple.Tuple("style", "color: green") ])([ DOM_Events.onClick(function (v1) {
          return Succ.value;
      }) ])([ DOM_VirtualDOM.text("succ") ]), DOM_Elements.code([  ])([  ])([ DOM_VirtualDOM.text("value") ]), DOM_Elements.ul([  ])([  ])([ DOM_Elements.li([  ])([  ])([ DOM_VirtualDOM.text("1") ]), DOM_Elements.li([  ])([  ])([ DOM_VirtualDOM.text("2") ]), DOM_Elements.li([  ])([  ])([ DOM_VirtualDOM.text("3") ]) ]) ]);
  };
  var rootComponent = {
      render: appRender,
      update: appUpdate,
      init: {
          buttonModel: new Button.Type(new Data_Maybe.Just("Void"))
      }
  };
  var app = {
      initialState: {
  ...
  exports["Succ"] = Succ;
  exports["Pred"] = Pred;
  exports["fromButtonMessage"] = fromButtonMessage;
