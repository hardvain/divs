...
(function(exports) {
      ...
      return function (v) {
          return function (channel) {
              var eventHandler = function (eventData) {
                  return DOM_Channel.send(v.value1(eventData))(channel);
              };
  ...
  var createElement = function (v) {
      return function (channel) {
          ...
          throw new Error("Failed pattern match at DOM.VirtualDOM (line 79, column 1 - line 79, column 69): " + [ v.constructor.name, channel.constructor.name ]);
      };
  };
  ...
  var runAppOnMessage = function (nodeToMount) {
      return function (app) {
          return function (oldModel) {
              return function (maybeMsg) {
                  return function __do() {
                      ...
                      var v2 = Effect_Ref["new"](app.init)();
                      var modelToRender = (function () {
                          var v3 = Data_Functor.map(Data_Maybe.functorMaybe)(app.update(oldModel))(maybeMsg);
                          ...
                          throw new Error("Failed pattern match at DOM.VirtualDOM (line 72, column 23 - line 74, column 44): " + [ v3.constructor.name ]);
                      })();
                      var htmlToRender = app.render(modelToRender);
                      var v3 = createElement(htmlToRender)(channel)();
                      return DOM_HTML_DOM.api.appendChild(v3)(nodeToMount)();
                  };
              };
          };
      };
  ...
  var runApp = function (app) {
      return function (model) {
          return function (nodeToMount) {
              return runAppOnMessage(nodeToMount)(app)(model)(Data_Maybe.Nothing.value);
          };
      };
  };
  var mount = function (nodeToMount) {
      return function (app) {
          return function __do() {
              ...
              var v1 = Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(runApp(app)(app.init))(v)();
...
(function(exports) {
  ...
  var appUpdate = function (model) {
      return function (message) {
          ...
          throw new Error("Failed pattern match at Main (line 19, column 3 - line 23, column 1): " + [ message.constructor.name ]);
      };
  };
