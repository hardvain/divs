  ...
  var createElement = function (dictShow) {
      return function (v) {
          return function (channel) {
              ...
              throw new Error("Failed pattern match at DOM.VirtualDOM (line 111, column 1 - line 115, column 17): " + [ v.constructor.name, channel.constructor.name ]);
          };
      };
  };
                  ...
                  return function (modelRef) {
                      return function (channel) {
                          return function __do() {
                              ...
                              return updateLoop(dictShow)(nodeToMount)(htmlToRender)(channel)();
                          };
                      };
                  };
              };
          ...
          return function (app) {
              return function (maybeMsg) {
                  return function __do() {
                      ...
                      var v3 = FRP_Event.subscribe(v2.event)(function (i) {
                          return callback(dictShow)(i)(nodeToMount)(app)(v)(v2.push);
                      })();
                      return updateLoop(dictShow)(nodeToMount)(htmlToRender)(v2.push)();
                  };
              };
          };
      };
