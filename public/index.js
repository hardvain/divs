...
(function(exports) {
  ...
  var PropertyAttribute = (function () {
      function PropertyAttribute(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      PropertyAttribute.create = function (value0) {
          return function (value1) {
              return new PropertyAttribute(value0, value1);
          };
      };
      return PropertyAttribute;
  })();
  var EventListenerAttribute = (function () {
      function EventListenerAttribute(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      EventListenerAttribute.create = function (value0) {
          return function (value1) {
              return new EventListenerAttribute(value0, value1);
          };
      };
      return EventListenerAttribute;
  })();
  exports["PropertyAttribute"] = PropertyAttribute;
  exports["EventListenerAttribute"] = EventListenerAttribute;
  exports["On"] = On;
...
(function(exports) {
  ...
  var style = function (k) {
      return new App.PropertyAttribute("style", k);
  };
  var onClick = function (h) {
      return new App.EventListenerAttribute("click", h);
  };
  exports["style"] = style;
  exports["onClick"] = onClick;
})(PS["DOM.Attributes"] = PS["DOM.Attributes"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var runApp = function (app) {
      return function (nodeToMount) {
          return function __do() {
              var v = Effect_Ref["new"](app.rootComponent.init)();
              var htmlToRender = app.rootComponent.render(app.rootComponent.init);
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Web_Event_EventTarget = PS["Web.Event.EventTarget"];                 
  var mapAttribute = function (v) {
      if (v instanceof App.PropertyAttribute) {
          return Data_Either.Left.create(new Data_Tuple.Tuple(v.value0, v.value1));
      };
      if (v instanceof App.EventListenerAttribute) {
          return Data_Either.Right.create(new App.On(v.value0, v.value1));
      };
      throw new Error("Failed pattern match at DOM.Elements (line 28, column 1 - line 28, column 86): " + [ v.constructor.name ]);
  };
  var mapAttributes = function (attributes) {
      return function (html1) {
          var f = function (attribute) {
              return function (v) {
                  if (v instanceof App.Element) {
                      var v1 = mapAttribute(attribute);
                      if (v1 instanceof Data_Either.Left) {
                          return new App.Element({
                              name: v.value0.name,
                              children: v.value0.children,
                              listeners: v.value0.listeners,
                              props: Data_Map_Internal.insert(Data_Ord.ordString)(Data_Tuple.fst(v1.value0))(Data_Tuple.snd(v1.value0))(v.value0.props)
                          });
                      };
                      ...
                      throw new Error("Failed pattern match at DOM.Elements (line 23, column 35 - line 25, column 158): " + [ v1.constructor.name ]);
                  };
                  return v;
              };
          };
          return Data_Foldable.foldr(Data_Foldable.foldableArray)(f)(html1)(attributes);
      };
  };
  var node = function (nodeName) {
      return function (attributes) {
          return function (children) {
              var html1 = DOM_VirtualDOM.h(nodeName)(Data_Map_Internal.empty)(children);
              return mapAttributes(attributes)(html1);
          };
      };
  };                                 
  var span = node("span");
...
(function(exports) {
    "use strict";
  var App = PS["App"];
  var DOM_Attributes = PS["DOM.Attributes"];
  ...
  var render = function (m) {
      return DOM_Elements.button([  ])([ DOM_VirtualDOM.text(m.text) ]);
  };
  var init = {
      text: "Button"
  };
...
(function(exports) {
  ...
  var update = function (model) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Text (line 17, column 1 - line 17, column 36): " + [ model.constructor.name, v.constructor.name ]);
      };
  };
  var render = function (m) {
      return DOM_Elements.span([  ])([ DOM_VirtualDOM.text(Data_Show.show(Data_Show.showInt)(m.value)) ]);
  };
  var init = {
      value: 0
  };
...
(function(exports) {
      ...
      return function (message) {
          if (message instanceof Succ) {
              return {
                  ...
                  textModel: Text.update(model.textModel)(Text.Succ.value)
              };
          };
          if (message instanceof Pred) {
              return {
                  buttonModel: model.buttonModel,
                  textModel: Text.update(model.textModel)(Text.Pred.value)
              };
          };
          throw new Error("Failed pattern match at Main (line 40, column 3 - line 42, column 64): " + [ message.constructor.name ]);
      };
  };
  var listItems = DOM_Elements.ul_([ DOM_Elements.li_([ DOM_VirtualDOM.text("1") ]), DOM_Elements.li_([ DOM_VirtualDOM.text("2") ]), DOM_Elements.li_([ DOM_VirtualDOM.text("3") ]) ]);
  var init = {
      buttonModel: Button.init,
      textModel: Text.init
  };
  var incrementButton = DOM_Elements.button([ DOM_Attributes.style("color: red"), DOM_Attributes.onClick(function (v) {
      return Succ.value;
  }) ])([ DOM_VirtualDOM.text("succ") ]);
  var decrementButton = DOM_Elements.button([ DOM_Attributes.style("color: red"), DOM_Attributes.onClick(function (v) {
      return Pred.value;
  }) ])([ DOM_VirtualDOM.text("pred") ]);
  var render = function (v) {
      return DOM_Elements.div([  ])([ DOM_Elements.div([ DOM_Attributes.style("color:red") ])([ DOM_VirtualDOM.text("children") ]), Button.render(v.buttonModel), Text.render(v.textModel), DOM_Elements.h1_([ DOM_VirtualDOM.text("Header") ]), decrementButton, incrementButton, DOM_Elements.code_([ DOM_VirtualDOM.text("value") ]), listItems ]);
  };
  var rootComponent = {
      render: render,
      update: update,
  ...
  exports["Succ"] = Succ;
  exports["Pred"] = Pred;
  exports["incrementButton"] = incrementButton;
  exports["decrementButton"] = decrementButton;
