...
(function(exports) {
      ...
      return function (old) {
          return function ($$new) {
              var update = function (key) {
                  ...
                  throw new Error("Failed pattern match at DOM.VirtualDOM (line 165, column 7 - line 169, column 38): " + [ v1.constructor.name, v.constructor.name ]);
              };
  ...
  var createElement = function (dictShow) {
      return function (v) {
          return function (channel) {
              ...
              throw new Error("Failed pattern match at DOM.VirtualDOM (line 115, column 1 - line 119, column 17): " + [ v.constructor.name, channel.constructor.name ]);
          };
      };
  };
                              ...
                              return function (v2) {
                                  return function (v3) {
                                      ...
                                      if (v1 instanceof Data_Maybe.Nothing && v2 instanceof Data_Maybe.Just) {
                                          return function __do() {
                                              var v4 = createElement(dictShow)(v2.value0)(channel)();
                                      ...
                                      if (v1 instanceof Data_Maybe.Just && v2 instanceof Data_Maybe.Nothing) {
                                          return function __do() {
                                              ...
                                              throw new Error("Failed pattern match at DOM.VirtualDOM (line 187, column 7 - line 189, column 29): " + [ v4.constructor.name ]);
                                          };
                                      };
                                      ...
                                      if (v1 instanceof Data_Maybe.Just && v2 instanceof Data_Maybe.Just) {
                                          return function __do() {
                                              ...
                                              if (v4 instanceof Data_Maybe.Just) {
                                                  var $105 = changed(dictShow)(v1.value0)(v2.value0);
                                                  if ($105) {
                                              ...
                                              throw new Error("Failed pattern match at DOM.VirtualDOM (line 198, column 7 - line 209, column 36): " + [ v4.constructor.name ]);
                                          };
                                      };
                                      throw new Error("Failed pattern match at DOM.VirtualDOM (line 179, column 5 - line 179, column 89): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name, v3.constructor.name ]);
                                  };
                              };
                          };
                      };
  ...
  var updateLoop = function (dictShow) {
      return function (nodeToMount) {
          return function (htmlToRender) {
              return function (channel) {
                  return function __do() {
                      var v = createElement(dictShow)(htmlToRender)(channel)();
                      return DOM_HTML_DOM.api.appendChild(v)(nodeToMount)();
                  };
              };
          };
      };
              ...
              return function (maybeMsg) {
                  return function __do() {
                      ...
                      var modelToRender = (function () {
                          ...
                          throw new Error("Failed pattern match at DOM.VirtualDOM (line 90, column 23 - line 92, column 44): " + [ v2.constructor.name ]);
                      })();
                      var htmlToRender = app.render(modelToRender);
                      ...
                      return updateLoop(dictShow)(nodeToMount)(htmlToRender)(v3.push)();
                  };
              };
          };
      };
