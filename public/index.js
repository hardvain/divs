...
(function(exports) {
  ...
  var render = function (v) {
      if (v.value0 instanceof Data_Maybe.Just) {
          return DOM_Combinators.withProps(DOM_Combinators.withChildren(DOM_Elements.button)([ DOM_VirtualDOM.text(v.value0.value0) ]))([ new Data_Tuple.Tuple("class", v.value0.value0) ]);
      };
      return DOM_Combinators.withChildren(DOM_Elements.button)([ DOM_VirtualDOM.text("Click Me") ]);
  };
  var component = {
      render: render,
      update: update,
...
(function(exports) {
  ...
  var appUpdate = function (model) {
      return function (message) {
          ...
          throw new Error("Failed pattern match at Main (line 46, column 3 - line 48, column 49): " + [ message.constructor.name ]);
      };
  };
  var appRender = function (v) {
      return DOM_Combinators.withChildren(DOM_Elements.div)([ DOM_Combinators.withProps(DOM_Combinators.withChildren(DOM_Elements.div)([ DOM_VirtualDOM.text("children") ]))([ new Data_Tuple.Tuple("style", "color:red") ]), Data_Functor.map(App.functorHtml)(function (v1) {
          return Succ.value;
      })(Button.component.render(v.buttonModel)), DOM_Combinators.withProps(DOM_Combinators.withChildren(DOM_Elements.h1)([ DOM_VirtualDOM.text("") ]))([ new Data_Tuple.Tuple("style", "color: red") ]), DOM_Combinators.withListeners(DOM_Combinators.withProps(DOM_Combinators.withChildren(DOM_Elements.button)([ DOM_VirtualDOM.text("pred") ]))([ new Data_Tuple.Tuple("style", "color: red") ]))([ DOM_Events.onClick(function (v1) {
          return Pred.value;
      }) ]), DOM_Combinators.withListeners(DOM_Combinators.withProps(DOM_Combinators.withChildren(DOM_Elements.button)([ DOM_VirtualDOM.text("succ") ]))([ new Data_Tuple.Tuple("style", "color: green") ]))([ DOM_Events.onClick(function (v1) {
          return Succ.value;
