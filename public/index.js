...
(function(exports) {
  ...
  var createElement$prime = function (api) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at DOM.VirtualDOM (line 61, column 1 - line 61, column 61): " + [ api.constructor.name, v.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var main = function __do() {
      ...
      if (v instanceof Data_Maybe.Just) {
          var v1 = DOM_VirtualDOM["createElement'"](DOM_HTML_DOM.api)(new DOM_VirtualDOM.Text("Aravindh"))();
      ...
      throw new Error("Failed pattern match at Main (line 15, column 5 - line 20, column 25): " + [ v.constructor.name ]);
  };
  exports["App"] = App;
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
