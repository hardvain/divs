...
(function(exports) {
  ...
  var createElement = function (api) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at DOM.VirtualDOM (line 61, column 1 - line 61, column 60): " + [ api.constructor.name, v.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var render = DOM_VirtualDOM.h("div")(DOM_VirtualDOM.prop([  ]))([ DOM_VirtualDOM.h("h1")(DOM_VirtualDOM.prop([ new Data_Tuple.Tuple("style", "color: red") ]))([ DOM_VirtualDOM.text("Number ") ]), DOM_VirtualDOM["with"](DOM_VirtualDOM.h("button")(DOM_VirtualDOM.prop([  ]))([ DOM_VirtualDOM.text("pred") ]))([ new DOM_VirtualDOM.On("click", function (v) {
      return function __do() {
          var v1 = Effect_Console.log("pred")();
      ...
      return function __do() {
          var v1 = Effect_Console.log("succ")();
          return Data_Unit.unit;
      };
  }) ]) ]);
  var main = function __do() {
      ...
      throw new Error("Failed pattern match at Main (line 25, column 5 - line 30, column 25): " + [ v.constructor.name ]);
  };
  exports["App"] = App;
